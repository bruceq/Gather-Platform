...
public class SpiderInfoController {
     ...
     * @return 是否删除
     */
    @RequestMapping(value = "batchDeleteById", method = RequestMethod.GET, produces = "application/json")
    @ResponseBody
    public ResultBundle<Boolean> batchDeleteById(List id) {
        return spiderInfoService.batchDeleteById(id);
    }
